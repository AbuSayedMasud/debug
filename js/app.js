...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <div class="span-area">
      <span class="span">Number of peoples: ${product.rating.count}</span>
      <span class="span"> rate: ${product.rating.rate}</span>
      </div>
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-success">add to cart</button>
      <button id="details-btn" onclick="deatils(${product.id})"class="btn btn-danger">Details</button></div>
      `;
